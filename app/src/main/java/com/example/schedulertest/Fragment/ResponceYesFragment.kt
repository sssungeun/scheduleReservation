...
import kotlinx.android.synthetic.main.fragment_main_detail_list_responce_yes.*

class ResponceYesFragment  : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_main_detail_list_responce_yes, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        rv_main_detail_responce_yes.adapter = responceRecyclerViewAdapter
        rv_main_detail_responce_yes.layoutManager = LinearLayoutManager(context!!, LinearLayoutManager.VERTICAL,false)
