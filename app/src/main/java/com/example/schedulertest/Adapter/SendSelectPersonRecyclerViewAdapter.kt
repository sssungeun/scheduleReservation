...
class SendSelectPersonRecyclerViewAdapter   (val ctx: Context, val dataList: ArrayList<PersonSelectData>): RecyclerView.Adapter<SendSelectPersonRecyclerViewAdapter.Holder>(){
