...
class SendSelectGroupRecyclerViewAdapter(val ctx: Context, val dataList: ArrayList<GroupSelectData>): RecyclerView.Adapter<SendSelectGroupRecyclerViewAdapter.Holder>(){
